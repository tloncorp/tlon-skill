...
function isActivityBucketCommand(command: string): command is ActivityBucketCommand {
...
async function showActivity(
  ...
  writeLine(deps.stdout, deps.format.activityHeader(bucket, bucketEvents.length));
